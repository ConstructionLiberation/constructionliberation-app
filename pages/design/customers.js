    ...
    <>
      ...
      <div style={{ background: '#1a1a19', color: '#fff', padding: '16px 24px' }}>
        {/* This page BELONGS to Design now, so back always means Design.
            ...
            It used to live under /admin and guess the destination from the
            user's ROLE - management to Design, everyone else to Admin. It was
            reachable from both places, so it was right for one route in and
            wrong for the other, for every role.
            
            Moving it removes the question rather than answering it. */}
        <a href="/design" style={{ color: '#bbb', fontSize: 13, textDecoration: 'none' }}>&lsaquo; Design</a>
