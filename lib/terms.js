...
export const TERMS = {
  ...
  rams: {
    ...
    status: 'statutory',
    note: 'AU SWMS is mandated for high-risk construction work with prescribed content. NZ follows similar practice under HSWA. A UK RAMS is NOT a compliant SWMS. The document itself needs review, not just the label.',
  },
