...
async function getRedis() {
  ...
  // No customer in scope: the global client. This is the single-tenant path and
  // it is what the app ran on until tenancy was switched on. It is also the
  // path that disappears when the global credentials are removed, at which
  // point anything still reaching it fails loudly instead of quietly reading
  // the wrong database.
  try {
