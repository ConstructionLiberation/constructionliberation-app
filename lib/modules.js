...
export const MODULES = [
  ...
  { id: 'hr',                  label: 'HR' },
  { id: 'lessons-learnt',      label: 'Lessons Learnt' },
...
//
// This used to force Operations, HR and Lessons Learnt on for every customer,
// on my assumption that the portal had no coherent shape without them. That was
// a guess about the PRODUCT, not a technical constraint, and it was not mine to
// make. A customer buying Design only is a perfectly good sale.
//
// Kept as an empty list rather than deleted, so the checks that reference it
// still read the same and it is obvious where the idea used to live.
