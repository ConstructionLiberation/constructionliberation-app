...
export const CHASE_MERGE_FIELDS = [
  ...
  '[Invoice Value]', '[Invoice Value inc VAT]', '[Our QS Name]',
]
...
// stageKey -> label, DERIVED from the templates above rather than typed out
// again. There were already three hand-written copies of this map and two of
// them had drifted: this file calls the last stage "Withdrawal from
// Contractual Obligations", pages/api/outstanding-invoices.js calls it
// "Withdrawal notice".
export const CHASE_STAGE_LABELS = CHASE_TEMPLATES.reduce((m, t) => {
  m[t.key] = t.label
  return m
}, {})
