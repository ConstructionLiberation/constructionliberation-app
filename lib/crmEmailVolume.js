import { msInternalDomain, msSyncGroup, msConfigured } from './tenantSettings'
...
const INTERNAL_DOMAIN = () => msInternalDomain()
...
export async function refreshEmailVolume({ months = 2, mailbox = '', max = 20000 } = {}) {
  ...
  // Same guard as runEmailSync. See the note at the top of crmEmailSync.js.
  ...
  let boxes = await listSyncMailboxes(msSyncGroup())
