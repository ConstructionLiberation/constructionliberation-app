...
export async function buildApprovalCertificate({ kind, projectNo, projectName, item, revision, fileName, fileHash, approver, atText, ts, eventId }) {
  ...
  text(companyName(), { f: bold, size: 16 })
  ...
  y -= 20
  wrapText(`This certificate was generated automatically by the ${companyName()} Design Portal at the moment of approval. The file fingerprint (SHA-256) identifies the exact version of the file that was approved; any change to the file would produce a different fingerprint. A corresponding entry is held in the portal's append-only approval audit log.`, { size: 8.5, color: GREY, gap: 3 })

  // Footer
  page.drawText(`${companyName()} - Digital Approval Certificate`, { x: M, y: M - 20, size: 8, font, color: GREY })
