...
// One rule, in lib/pdfText.js. There were FOUR versions of this across the PDF
// builders and they disagreed: this one kept the pound sign but replaced every
// accented character with a space, so a name like Jose Nunez came out mangled on
// a document that goes to customers. handoverPdf dropped the pound sign
// entirely. preStartPdf had none at all and threw on a pasted curly quote.
const san = pdfText
